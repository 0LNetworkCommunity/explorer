interface CommunityWalletInfo {
  name?: string;
  description?: string;
}

export const communityWallets = new Map<string, CommunityWalletInfo>([
  [
  ...
  [
    ...
    {
      name: "Ongoing Full-Time Workers Program",
      description:
  ...
  [
    ...
    {
      name: "The Iqlusion Engineering Fund",
      description:
  ...
  [
    "C19C06A592911ED31C4100E9FB63AD7B",
    {
      ...
      description:
        "The RadicalxChange Foundation has established this  Research and Experimentation fund to advance new incentive structures.",
    },
  ],
  [
