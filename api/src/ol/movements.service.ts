...
export class MovementsService {
  ...
  private async getUserTransactions(
    ...
    const userTransactionRows: UserTransactionDbEntity[] = await resUserTransaction.json();
  ...
  private async getBlockMetadataTransactions(
    ...
    const blockMetadataTransactionRows: BlockMetadataTransactionDbEntity[] =
  ...
  private async getScriptUserTransactions(
    ...
    const scriptUserTransactionRows: ScriptUserTransactionDbEntity[] =
  ...
  private async getGenesisTransactions(
    ...
    const genesisTransactionRows: GenesisTransactionDbEntity[] =
