...
- Merge pull request #11 from 0LNetworkCommunity/feat/lei_changelog
...
- Merge pull request #10 from 0LNetworkCommunity/feat/lei_changelog
- [*] add new config to updatechangelog script
- [*] bash script changelog update
- [*] right access to scripts/
- [*] change access dir to scripts/
...
- Merge pull request #9 from 0LNetworkCommunity/feat/lei_changelog
- [*] bash script changelog update
- [*] right access to scripts/
- [*] change access dir to scripts/
- [*] rename update changelog file to generate_changelog
